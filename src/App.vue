...
if (getZlibData.ok && getWebData.ok) {
  ...
  const WebStatusText = "\n\nWeb Uptime Ping:\n\n * MaimaiDXCN: " + ConvertFloat(preparedWebData.details["maimai DX CN DXNet"].uptime * 100)+ "\n\n * MaimaiDXCN Main Server: " + ConvertFloat(preparedWebData.details["maimai DX CN NetLogin"].uptime * 100) + "\n\n * MaimaiDXCN Title Server: " + ConvertFloat(preparedWebData.details["maimai DX CN Main"].uptime * 100) + "\n\n * MaimaiDXCN Update Server: " + ConvertFloat(preparedWebData.details["maimai DX CN Update"].uptime * 100) + "\n\n * MaimaiDXCN NetLogin Server: " + ConvertFloat(preparedWebData.details["maimai DX CN Title"].uptime * 100) + "\n\n * MaimaiDXCN Net Server: " + ConvertFloat(preparedWebData.details["maimai DX CN"].uptime * 100) + "\n"
